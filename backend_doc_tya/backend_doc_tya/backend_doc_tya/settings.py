"""
Django settings for backend_doc_tya project.
...
ROOT_URLCONF = 'backend_doc_tya.urls'
...
WSGI_APPLICATION = 'backend_doc_tya.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Только permission-классы здесь
    ],
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # JWT
        # 'rest_framework.authentication.TokenAuthentication',          # DRF Token (опционально)
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=24),   # ← токен живёт сутки
